...
- Still banned — the Vietnamese-law line, which always beats revenue:
  ...
  4. False scarcity, countdowns, fabricated reference or crossed-out prices,
     misleading promotion terms, and fake experts or teams
     (FD-064, FD-071).
...
- 2026-09-26: the founder removed the spec's testimonial ban. Reader quotes
  on the homepage are real customer feedback.
