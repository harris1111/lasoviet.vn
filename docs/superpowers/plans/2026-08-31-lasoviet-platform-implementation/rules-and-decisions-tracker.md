...
| FD-041 | 2026-09-09 | Upgrade credit (tier 1 → tier 2) expires 7 days after the tier-1 purchase, overriding An's no-expiry recommendation; must be disclosed at the tier-1 purchase point before payment confirmation | Approved | Same round-2 doc |
...
| FD-045 | 2026-09-09 | Reject any odd-cent amount surcharge for payment reconciliation — displayed/charged prices must always be round, no exceptions. Replace the amount-only auto-match tier with a customer self-claim flow gated by an exact-amount match within a narrow customer-declared transfer time window | Approved (revised) | Same round-2 doc |
...
| FD-047 | 2026-09-09 | Out-of-band alert channel for the circuit breaker and stale unmatched transactions (>6h) is a Telegram bot posting to the shared Harris/An operations group; founder SLA is to check within 6 hours | Approved | Same round-2 doc |
...
| FD-051 | 2026-09-09 | Long-term analytics storage is self-hosted within existing infrastructure; no third-party SaaS as the primary store | Approved | Same round-2 doc |
...
| FD-055 | 2026-09-09 | The approved UI artifact branch for WP-03/WP-06/WP-11/WP-13 (per FD-024) is `product/discipline-flagship-pages`; founder to confirm whether other in-flight UI branches (`product/bg-texture-consistency`, `product/homepage-content-rewrite`) need merging into it first | Approved | Same round-2 doc |
