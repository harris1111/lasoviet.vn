...
| FD-101 | 2026-09-24 | The homepage shows the four Lá top-up packs with Lá and VND side by side, using the FD-066 values (Nhập Môn 29,000 đ → 300 Lá; Khởi Đọc 99,000 đ → 1,100 Lá; Khám Phá 249,000 đ → 3,000 Lá; Tàng Thư 599,000 đ → 8,000 Lá). The pack figures in the 2026-09-23 homepage content spec were wrong and are replaced. Content, unlock, and upgrade prices still appear in `Lá` only (FD-065). Amends FD-069 for the homepage | Approved | `apps/web/src/features/homepage-v3/homepage-v3-static-sections.tsx` |
