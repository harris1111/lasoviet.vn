...
> (2026-09-20) sẽ build thêm một **light theme**, lấy bảng Giấy–Mực–Son trong
> `docs/24` làm điểm xuất phát. Art direction trong file này — nền sẫm,
...
> **typography (§5.3)**, iconography (§5.6),
> **motion (§5.8)**, voice, and the banned list. Layout and components: spec FD-091.
>
