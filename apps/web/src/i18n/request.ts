...
const messages = {
  vi: {common: viCommon, navigation: viNavigation, auth: viAuth, profile: viProfile, reports: viReports, ziwei: viZiwei, account: viAccount},
  en: {common: enCommon, navigation: enNavigation, auth: enAuth, profile: enProfile, reports: enReports, ziwei: enZiwei, account: enAccount},
};
