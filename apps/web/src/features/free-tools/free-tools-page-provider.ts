...
const HUB_CONTENT_VI: FreeToolsHubContent = {
  ...
  tools: [
    ...
    },
    {
      ...
      body: "So khớp hướng nhà với cung mệnh theo Bát Trạch — utility đã chốt, công thức đang hoàn thiện.",
...
const HUB_CONTENT_EN: FreeToolsHubContent = {
  ...
  tools: [
    ...
    },
    {
      ...
      body: "Align house directions with personal trigrams under Eight Mansions — settled utility, formulas still being finalized.",
...
const PATH_TO_TOOL_KEY: Record<string, FreeToolKey> = {
  ...
  "/tra-cuu-than-so-hoc": "numerology",
  "/boi-tinh-yeu": "love-compatibility",
  "/tu-vi-hom-nay": "daily-horoscope",
};
