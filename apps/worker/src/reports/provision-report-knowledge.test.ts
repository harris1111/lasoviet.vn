...
describe("provisionReportKnowledge", () => {
  ...
  it("throws REPORT_KNOWLEDGE_PROVISION_FAILED when VI manifest fails ingestion", async () => {
  ...
  it("throws REPORT_KNOWLEDGE_PROVISION_FAILED when EN manifest fails ingestion", async () => {
